...
public class LoginPageTest extends BaseTest
{
    ...
    TopMenuTest top;
    DesktopsTest destops ;
    LaptopsAndNotebooksTest laptop ;
    MyAccountsTest myAccount ;

    @BeforeMethod(groups = {"sanity","smoke","regression","regression1"})
    public void iNit()
    {
        top = new TopMenuTest();
        destops = new DesktopsTest();
        laptop = new LaptopsAndNotebooksTest();
        myAccount = new MyAccountsTest();
